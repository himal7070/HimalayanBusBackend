...
//        when(busRepository.findById(anyLong())).thenReturn(Optional.of(mockBus));
//
...
//
//        Reservation result = reservationService.addReservation(reservationDTO, 1L);
//
...
////
////        // Asserting the exception
////        assertThrows(ReservationException.class, () -> reservationService.addReservation(reservationDTO, 1L));
////
////        // Verifying interactions with userRepository
////        verify(userRepository, times(1)).findById(anyLong());
////        verifyNoMoreInteractions(userRepository);
////
////        // Verifying interactions with routeRepository
////        verify(routeRepository, times(1)).findByRouteFromAndRouteTo(anyString(), anyString());
////        verifyNoMoreInteractions(routeRepository);
////
////        // Verifying interactions with busRepository
////        verify(busRepository, times(1)).findByRoute(any());
////        verifyNoMoreInteractions(busRepository);
////
////        // Verifying no interactions with reservationRepository
////        verifyNoInteractions(reservationRepository);
////    }
//
//
